...
\hline
Autenticación de usuarios & Prueba funcional & Exitosa \\
\hline
Registro de clientes & Prueba de integración & Exitosa \\
\hline
Proceso de compra completo & Prueba de flujo completo & Exitosa \\
\hline
Gestión de productos (CRUD) & Prueba CRUD & Exitosa \\
\hline
Cálculo de descuentos por membresía & Prueba unitaria & Exitosa \\
\hline
Actualización de stock concurrente & Prueba concurrente & Exitosa \\
\hline
Persistencia en base de datos & Prueba de integración & Exitosa \\
\hline
Gestión de sesiones & Prueba de estado & Exitosa \\
\hline
\end{tabular}
\end{table}

...
\lstdefinestyle{javastyle}{
    ...
    tabsize=4,
    captionpos=b,
    morekeywords={String, int, boolean, double, List, ArrayList, Timestamp},
    literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1
}

% Estilo SQL para listings
\lstdefinestyle{sqlstyle}{
    ...
    tabsize=4,
    captionpos=b,
    morekeywords={SELECT, FROM, WHERE, INSERT, UPDATE, DELETE, CREATE, TABLE, INT, VARCHAR, PRIMARY, KEY, FOREIGN, REFERENCES, NOT, NULL}
}
...
% Entorno para código SQL
\newtcblisting{sqlcode}[2][]{
    listing only,
    listing style=sqlstyle,
    colback=codebackground,
    colframe=codeframe,
    left=8mm,
    right=4mm,
